...
def addStockMinute(stockName, resPath, listOfLines):
    stockID = []
    everyDate = []
    startP = []
    highP = []
    ...
    for i in range(len(listOfLines) - 1):
        ...
        minuteList.append(line[1])
        startP.append(line[2])
        highP.append(line[3])
        lowP.append(line[4])
        endP.append(line[5])
        dealN.append(line[6])
        dealM.append(line[7])
        listOf5.append(float(line[5]))
        listOf10.append(float(line[5]))
        listOf20.append(float(line[5]))
        listOf30.append(float(line[5]))
        listOf60.append(float(line[5]))
        listOf120.append(float(line[5]))
        listOf250.append(float(line[5]))
    ...
    for i in range(len(everyDate)):
        ...
        sheet.write(i + 1 - 251, 49, minuteList[i])
