<template>
    ...
    <div class="resultDisplay" v-if="data.showResult">
        <el-input readonly="true" style="display: inline-block; margin-right: 20px; width: 180px;" v-model="data.loss" />
        <el-input readonly="true" style="display: inline-block; margin-right: 20px; width: 180px;" v-model="data.mape" />
        <el-input readonly="true" style="display: inline-block; margin-right: 20px; width: 180px;" v-model="data.rootMeanSquaredError" />
    </div>
...
import { fillData, getRequest, message, messageDuration, postRequest } from "@/utils/api";
        ...
        function predict(type) {
            ...
            postRequest("/stockData/lstm", {
                ...
                if (res.data.code == 200) {
                    ...
                    data.loss = "损失精度：" + res.data.data[1];
                    data.mape = "偏差精度：" + res.data.data[2];
